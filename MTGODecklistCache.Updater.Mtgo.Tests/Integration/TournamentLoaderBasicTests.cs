    ...
    public class TournamentLoaderBasicTests
    {
        ...
        public void TournamentDataIsCorrect()
        {
            _testData.Should().BeEquivalentTo(new Tournament[]
            {
                ...
                new Tournament(){ Date=new DateTime(2020, 06, 02, 00, 00, 00, DateTimeKind.Utc), Name="Modern Preliminary",      Uri=new Uri("https://www.mtgo.com/decklist/modern-preliminary-2020-06-0212162954"),      JsonFile="modern-preliminary-2020-06-0212162954.json" },
                new Tournament(){ Date=new DateTime(2020, 06, 02, 00, 00, 00, DateTimeKind.Utc), Name="Pioneer Preliminary",     Uri=new Uri("https://www.mtgo.com/decklist/pioneer-preliminary-2020-06-0212162951"),     JsonFile="pioneer-preliminary-2020-06-0212162951.json" },
