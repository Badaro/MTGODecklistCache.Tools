    ...
    public class TournamentLoaderCrossYearTests
    {
        ...
        public void TournamentDataIsCorrect()
        {
            _testData.Should().BeEquivalentTo(new Tournament[]
            {
                ...
                new Tournament(){ Date=new DateTime(2022, 01, 01, 00, 00, 00, DateTimeKind.Utc), Name="Pioneer Preliminary",     Uri=new Uri("https://www.mtgo.com/decklist/pioneer-preliminary-2022-01-0112367808"),     JsonFile="pioneer-preliminary-2022-01-0112367808.json" },
                new Tournament(){ Date=new DateTime(2022, 01, 01, 00, 00, 00, DateTimeKind.Utc), Name="Modern Preliminary",      Uri=new Uri("https://www.mtgo.com/decklist/modern-preliminary-2022-01-0112367807"),      JsonFile="modern-preliminary-2022-01-0112367807.json" },
                ...
                new Tournament(){ Date=new DateTime(2021, 12, 31, 00, 00, 00, DateTimeKind.Utc), Name="Pioneer Preliminary",     Uri=new Uri("https://www.mtgo.com/decklist/pioneer-preliminary-2021-12-3112367805"),     JsonFile="pioneer-preliminary-2021-12-3112367805.json" },
                new Tournament(){ Date=new DateTime(2021, 12, 31, 00, 00, 00, DateTimeKind.Utc), Name="Vintage Preliminary",     Uri=new Uri("https://www.mtgo.com/decklist/vintage-preliminary-2021-12-3112367804"),     JsonFile="vintage-preliminary-2021-12-3112367804.json" },
                new Tournament(){ Date=new DateTime(2021, 12, 31, 00, 00, 00, DateTimeKind.Utc), Name="Legacy Preliminary",      Uri=new Uri("https://www.mtgo.com/decklist/legacy-preliminary-2021-12-3112367802"),      JsonFile="legacy-preliminary-2021-12-3112367802.json" },
                new Tournament(){ Date=new DateTime(2021, 12, 31, 00, 00, 00, DateTimeKind.Utc), Name="Modern Preliminary",      Uri=new Uri("https://www.mtgo.com/decklist/modern-preliminary-2021-12-3112367801"),      JsonFile="modern-preliminary-2021-12-3112367801.json" },
                new Tournament(){ Date=new DateTime(2021, 12, 31, 00, 00, 00, DateTimeKind.Utc), Name="Legacy Preliminary",      Uri=new Uri("https://www.mtgo.com/decklist/legacy-preliminary-2021-12-3112367799"),      JsonFile="legacy-preliminary-2021-12-3112367799.json" },
                new Tournament(){ Date=new DateTime(2021, 12, 31, 00, 00, 00, DateTimeKind.Utc), Name="Pioneer Preliminary",     Uri=new Uri("https://www.mtgo.com/decklist/pioneer-preliminary-2021-12-3112367798"),     JsonFile="pioneer-preliminary-2021-12-3112367798.json" },
